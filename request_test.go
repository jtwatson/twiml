...
func TestParseNumber(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Valid App without prefix", args: args{v: "AP12345678901234567890123456789012"}, want: &ParsedNumber{Valid: true, App: true, AppID: "AP12345678901234567890123456789012", Number: "AP12345678901234567890123456789012", Raw: "AP12345678901234567890123456789012"}},
		{name: "Valid App with prefix", args: args{v: "app:AP12345678901234567890123456789012"}, want: &ParsedNumber{Valid: true, App: true, AppID: "AP12345678901234567890123456789012", Number: "AP12345678901234567890123456789012", Raw: "app:AP12345678901234567890123456789012"}},
